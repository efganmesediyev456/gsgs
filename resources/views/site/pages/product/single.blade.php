    ...
    <main class="main mb-10 pb-1">
        ...
        <nav class="breadcrumb-nav container">
            <ul class="breadcrumb bb-no">
                <li><a href="/{{app()->getLocale()}}">{{ __('frontend.home_page') }}</a></li>
                <li><a href="/{{app()->getLocale()}}/products">{{ __('frontend.products_page') }}</a></li>
                <li>{{ $item->title }}</li>
            </ul>
                                        ...
                                        <div class="swiper-wrapper row cols-1 gutter-no">
                                            ...
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="{{ get_image($item->image) }}" data-zoom-image="{{ get_image($item->image) }}" alt="Electronics Black Wrist Watch" width="800" height="900">
                                                </figure>
                                            </div>
                                            ...
                                            @foreach($item->media->where('status',1)->sortByDesc('id') as $media)
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="{{ get_image($media->file) }}" data-zoom-image="{{ get_image($media->file) }}" alt="Electronics Black Wrist Watch" width="800" height="900">
                                                    </figure>
                                                </div>
                                            @endforeach
                                        </div>
                                    ...
                                    <div class="product-thumbs-wrap swiper-container" data-swiper-options="{
                                        ...
                                        <div class="product-thumbs swiper-wrapper row cols-4 gutter-sm">
                                            <div class="product-thumb swiper-slide">
                                                <img src="{{ get_image($item->image) }}" alt="Product Thumb" width="800" height="900">
                                            </div>

                                            @foreach($item->media->where('status',1)->sortByDesc('id') as $media)
                                                <div class="product-thumb swiper-slide">
                                                    <img src="{{ get_image($media->file) }}" alt="Product Thumb" width="800" height="900">
                                                </div>
                                            @endforeach
                                        </div>
                                        <button class="swiper-button-next"></button>
...
{{--                                        <figure class="brand">--}}
{{--                                            <img src="/assets/images/logo/logo-removebg-preview.png" alt="Brand" width="102" height="48" />--}}
{{--                                        </figure>--}}
                                        <div class="product-meta">
                                            ...
                                            <div class="product-sku">
                                                @lang('frontend.sku'): <span>{{ $item->sku }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product-price">
                                        <ins class="new-price">{{ number_format($item->price, 2) }} AZN</ins>
                                        @if($item->discount_price)
                                        <del class="old-price">{{ number_format($item->discount_price, 2) }} AZN</del>
                                        @endif
                                    </div>
                                    ...
                                    <div class="fix-bottom product-sticky-content sticky-content">
                                        <div class="product-form container">
                                            ...
                                            <a href="#" data-number="{{ $mainsetting->whatsapp }}" data-message="{{ __('frontend.i_want_to_buy_this_product') . ' ' . $item->title . ' : ' . product_slug($item->slug) }}" class="btn btn-primary btn-cart">
                                                <span>@lang('frontend.order_with_whatsapp')</span>
...
{{--                                            <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt arcu cursus vitae congue mauris. Sagittis id consectetur purus ut. Tellus rutrum tellus pelle Vel pretium lectus--}}
...
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                    <p class="mb-5"><strong class="text-dark">L</strong>orem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Venenatis tellus in metus vulputate eu scelerisque felis.--}}
{{--                                        Vel pretium lectus quam id leo in vitae turpis massa. Nunc id cursus metus aliquam. Libero id faucibus nisl tincidunt eget. Aliquam id diam maecenas ultricies mi eget mauris. Volutpat ac tincidunt vitae semper--}}
{{--                                        quis lectus. Vestibulum mattis ullamcorper velit sed. A arcu cursus vitae congue mauris.--}}
{{--                                    </p>--}}
{{--                                    <p class="mb-2"><strong class="text-dark">A</strong> arcu cursus vitae congue mauris. Sagittis id consectetur purus ut. Tellus rutrum tellus pellentesque eu tincidunt tortor aliquam nulla. Diam in arcu cursus euismod quis. Eget--}}
{{--                                        sit amet tellus cras adipiscing enim eu. In fermentum et sollicitudin ac orci phasellus. A condimentum vitae sapien pellentesque habitant morbi tristique senectus et. In dictum non consectetur a erat. Nunc scelerisque--}}
...
{{--                                                                    </div>--}}
{{--                                                                </div>--}}
{{--                                                                <p>pellentesque habitant morbi tristique senectus et. In dictum non consectetur a erat. Nunc ultrices eros in cursus turpis massa tincidunt ante in nibh mauris cursus mattis. Cras ornare--}}
{{--                                                                    arcu dui vivamus arcu felis bibendum ut tristique.</p>--}}
...
{{--                                                                    </div>--}}
{{--                                                                </div>--}}
{{--                                                                <p>Nullam a magna porttitor, dictum risus nec, faucibus sapien. Ultrices eros in cursus turpis massa tincidunt ante in nibh mauris cursus mattis. Cras ornare arcu dui vivamus arcu felis--}}
{{--                                                                    bibendum ut tristique.</p>--}}
{{--                                                                <div class="comment-action">--}}
{{--                                                                    <a href="#" class="btn btn-secondary btn-link btn-underline sm btn-icon-left font-weight-normal text-capitalize">--}}
{{--                                                                        <i class="far fa-thumbs-up"></i>Helpful (1)--}}
{{--                                                                    </a>--}}
...
{{--                                                                    </div>--}}
{{--                                                                </div>--}}
{{--                                                                <p>In fermentum et sollicitudin ac orci phasellus. A condimentum vitae sapien pellentesque habitant morbi tristique senectus et. In dictum non consectetur a erat. Nunc scelerisque viverra--}}
...
{{--                        </div>--}}
                        <section class="vendor-product-section">
                            <div class="title-link-wrapper mb-4">
                                <h4 class="title text-left">@lang('frontend.similar_products')</h4>
                                <a href="/{{app()->getLocale()}}/products" class="btn btn-dark btn-link btn-slide-right btn-icon-right">@lang('frontend.more_products')<i class="w-icon-long-arrow-right"></i></a>
                            </div>
                                ...
                                <div class="swiper-wrapper row cols-lg-3 cols-md-4 cols-sm-3 cols-2">
                                    ...
                                    <div class="swiper-slide product">
                                        <figure class="product-media">
                                            <a href="{{ product_slug($item->slug) }}">
                                                <img src="{{ get_image($item->image) }}" alt="Product"
...
{{--                                            </div>--}}
                                            <div class="product-action">
                                                <a href="{{ product_slug($item->slug) }}" class="btn-product btn-quickview" title="Quick View">@lang('frontend.quick_view')</a>
                                            </div>
                                        </figure>
                                        <div class="product-details">
{{--                                            <div class="product-cat"><a href="shop-banner-sidebar.html">Accessories</a>--}}
                                            </div>
                                            <h4 class="product-name"><a href="{{ product_slug($item->slug) }}">{{ $item->title }}</a>
                                            </h4>
{{--                                            <div class="ratings-container">--}}
{{--                                                <div class="ratings-full">--}}
{{--                                                    <span class="ratings" style="width: 100%;"></span>--}}
...
{{--                                            </div>--}}
                                            <div class="product-pa-wrapper">
                                                <div class="product-price">@if($item->price){{$item->price}} AZN @endif @if($item->discount_price) {{$item->discount_price}}- {{$item->discount_price}}AZN @endif</div>
                                            </div>
                                        </div>
                                    ...
                                    @foreach($features as $feature)
                                        <div class="icon-box icon-box-side">
                                            <span class="icon-box-icon text-dark">
                                                  <img style="max-width: 34px" src="{{ get_image($feature->icon) }}" alt="">
                                            </span>
                                        <div class="icon-box-content">
                                            <h4 class="icon-box-title">{{ $feature->title }}</h4>
...
{{--                                </div>--}}
                                ...
                                <div class="widget widget-products">
                                    <div class="title-link-wrapper mb-2">
                                        <h4 class="title title-link font-weight-bold">@lang('frontend.sidebar_more_products')</h4>
                                    </div>
                                    ...
                                    <div class="swiper nav-top">
                                        <div class="swiper-container swiper-theme nav-top" data-swiper-options="{
                                            ...
                                            <div class="swiper-wrapper">
                                                @foreach($moreproducts->chunk(3) as $chunks)
                                                <div class="widget-col swiper-slide">
                                                    @foreach($chunks as $chunk)
                                                    <div class="product product-widget">
                                                        <figure class="product-media">
                                                            <a href="#">
                                                                <img src="{{ get_image($chunk->image) }}" alt="Product"
                                                                     width="100" height="113" />
                                                            </a>
                                                        </figure>
                                                        <div class="product-details">
                                                            <h4 class="product-name">
                                                                <a href="{{ product_slug($chunk->slug) }}">{{ $chunk->title }}</a>
                                                            </h4>
                                                            <div class="product-price">@if($chunk->price){{$chunk->price}} AZN @endif @if($chunk->discount_price) {{$chunk->discount_price}}- {{$chunk->discount_price}}AZN @endif</div>
                                                        </div>
                                                    </div>
                                                    @endforeach
                                                </div>
