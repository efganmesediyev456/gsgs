<form id="saveForm" action="{{$route}}" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="category-name" name="url" value="{{$item->url}}" placeholder="Urli daxil edin">
    </div>
    <div class="mb-3">
        <label for="category-name" class="form-label">Ikon</label>
